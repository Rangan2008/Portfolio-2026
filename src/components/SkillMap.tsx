...
export const SkillConstellationMap = memo(() => {
  ...
  return (
    <div className="relative w-full min-h-[500px] md:min-h-[700px] bg-[#0d1829]/50 rounded-3xl border border-teal-500/10 overflow-hidden p-4 md:p-8">
      <svg className="w-full h-full min-h-[450px] md:min-h-[650px]" viewBox="-5 -5 110 110" preserveAspectRatio="xMidYMid meet">
      ...
      <AnimatePresence>
        {hoveredSkill && (
          <motion.div
            ...
            className="absolute z-[100] w-[220px] pointer-events-none hidden md:block"
            style={{
