    ...
    <div className="bg-[#060b14] text-[#e2e8f0] font-sans selection:bg-teal-400 selection:text-navy-950 min-h-screen">
      ...
      >
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }} className="px-6 md:px-12 lg:px-24">


          <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] items-center gap-16 lg:gap-24">
            ...
            <div className="space-y-10">
              ...
              >
                <button
                  ...
                  className="group relative px-8 py-4 bg-teal-400 text-[#060b14] font-bold rounded-xl overflow-hidden transition-all hover:shadow-[0_0_20px_rgba(0,229,204,0.4)]"
                >
                ...
                <button
                  ...
                  className="px-8 py-4 bg-transparent border border-teal-400/30 text-teal-400 font-bold rounded-xl hover:bg-teal-400/5 transition-all"
                >
                  Initiate Contact
                </button>
        ...
        <section id="about" className="py-32 px-6 md:px-12 lg:px-24 relative overflow-hidden">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                <div className="bg-[#0d1829]/40 border border-teal-500/10 rounded-3xl p-8 md:p-12 backdrop-blur-sm relative overflow-hidden group">
              ...
              <motion.div
                ...
                className="space-y-8"
              >
                <div className="bg-[#0d1829] border border-teal-500/20 rounded-3xl p-8 relative overflow-hidden h-full">
          ...
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <motion.div
                ...
                initial={{ y: 20, opacity: 0 }}
                viewport={{ once: true }}
                className="lg:col-span-2 p-10 bg-[#0d1829] border border-teal-500/10 rounded-3xl flex flex-col justify-center gap-6 group hover:border-teal-500/30 transition-all relative overflow-hidden"
              >
              ...
              <div className="lg:col-span-1 flex flex-col gap-8">
                {ACHIEVEMENTS.slice(1).map((ach, i) => (
                  <motion.div
                    ...
                    className="flex-1 p-8 bg-[#0d1829] border border-teal-500/10 rounded-3xl flex flex-col justify-center gap-4 group hover:border-teal-500/30 transition-all relative overflow-hidden"
                  >
        ...
        <section id="contact" className="py-32 px-6 md:px-12 lg:px-24 mb-20 relative">
          ...
          <div className="max-w-6xl mx-auto bg-gradient-to-br from-[#0d1829]/80 to-[#060b14]/80 backdrop-blur-md border border-teal-500/20 rounded-[3rem] p-12 md:p-20 relative overflow-hidden z-10">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-20">
              ...
              <div className="flex-1 flex flex-col justify-center">
                <div className="p-8 rounded-3xl bg-[#060b14]/50 border border-teal-500/10 backdrop-blur-md">
